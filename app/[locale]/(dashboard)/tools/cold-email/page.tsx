...
export default createToolPage({
  ...
  upgradeCopy: 'Upgrade to Orbit (€79/mo) to unlock the Cold Email Machine — generate complete cold email sequences with A/B variants, personalisation, and optimal send timing.',
  quickActions: [
