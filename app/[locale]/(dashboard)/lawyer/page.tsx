...
export default function LawyerPage() {
  ...
  const workflow = useWorkflowProgress('lawyer')
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-56px)] md:h-screen">
      {ctxLoading ? (
        ...
        <div className="flex-1 flex items-center justify-center p-8"><div className="max-w-2xl text-center"><Scale size={48} className="text-accent mx-auto mb-4 opacity-50" /><h1 className="text-2xl font-bold text-dashText mb-2">ELEVO Lawyer™</h1><p className="text-dashMuted mb-6">Available on Orbit plan and above.</p><a href={`/${locale}/pricing`} className="inline-block px-6 py-3 bg-accent text-white font-semibold rounded-xl">Upgrade to Orbit →</a></div></div>
      ) : (<>
      {/* Header */}
