  ...
  const schemas = [
    {
      ...
      offers: [
        ...
        { '@type': 'Offer', name: 'Launch', price: '39', priceCurrency: 'GBP' },
        { '@type': 'Offer', name: 'Orbit', price: '79', priceCurrency: 'GBP' },
        { '@type': 'Offer', name: 'Galaxy', price: '149', priceCurrency: 'GBP' },
      ],
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'How much does ELEVO AI cost?', acceptedAnswer: { '@type': 'Answer', text: 'Plans start at £39/month. 7-day free trial, no card required.' } },
