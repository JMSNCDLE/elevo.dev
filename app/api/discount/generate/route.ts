...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await sendEmail({
      ...
      html: `<p>Hi! Your ELEVO AI™ discount code is: <strong>${code}</strong></p><p>50% off your first month. Valid for 24 hours.</p><p><a href="https://elevo.dev/en/pricing">Claim at elevo.dev/pricing →</a></p>`,
    })
  } catch (_) {
    // Non-fatal
  }
