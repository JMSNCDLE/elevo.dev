...
export function GET(request: NextRequest) {
  ...
  const subtitle = searchParams.get('subtitle') ?? '60+ AI agents that replace your entire team. From €39/month.'
        ...
        >
          ...
          >
            <div style={{ display: 'flex', gap: '24px' }}>
              {['400+ businesses', '€1.2M saved', '60+ AI agents', '99.9% uptime'].map(stat => (
