...
- **Launch** (€39/mo): Content tools, CRM (100 contacts), Problem Solver, 500 credits/mo.
- **Orbit** (€79/mo): Everything in Launch + all Growth, Intelligence, Social & Media tools. Unlimited contacts. 1,500 credits/mo.
- **Galaxy** (€149/mo): Everything in Orbit + Ecommerce, Deep™, white-label, API access, team members. 5,000 credits/mo.
