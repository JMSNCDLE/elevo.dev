...
export async function generateELEVOOwnAds(
  ...
  const brief: AdCampaignBrief = {
    businessProfile: {
      ...
      unique_selling_points: ['21 AI agents', '4 pillars in one platform', 'Replaces £500/mo of tools', 'From £39/month'],
      is_primary: true,
    } as BusinessProfile,
    ...
    uniqueSellingPoint: '21 AI agents from £39/month — replaces £500+ of separate tools',
    locale,
  }
